                ...
                <div class="row">
                    ...
                    <div class="form-gourp.col.md-4 mt=3">
                        <div>
                            ...
                            <input type="text" class="form-control" id="title1" name="title1" value="{{ $educations->title1}}">
                        </div>

                        <div>
                            <div class="mb-5">
                            <label for="title"><h4>Title 2</h4></label>
                            <input type="text" class="form-control" id="title2" name="title2" value="{{ $educations->title2}}">
                        </div>
                        <div>
                        <div class="form-group col-md-6 mt-3">
                            <label for="description"><h4>Description</h4></label>
                            <textarea type="text" class="form-control" id="description" name="description" value="{{ $educations->description}}"> </textarea>
                        </div>
                    </div>
                </div>
